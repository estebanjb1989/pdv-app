...
import { useBackButton, useHeaderTitle, useHeaderRight, useUser } from '../../hook'
...
const Staff = () => {
    ...
    useHeaderRight(() => {
        return (
            <Container row alignCenter onPress={() => {
                dispatch(bsActions.open('AddMember', {
                    onSubmit: (values) => {
                        submitMember(values)
    ...
    return (
        <Container padded flex spaceBetween>
            <FlatList
                            ...
                            <Container row spaceBetween alignCenter>
                                ...
                                <Container>
                                    <Picker
                                        ...
                                        onValueChange={(itemValue) => setSelectedValues({
                                            ...selectedValues,
                                            [item.email]: itemValue
                                        })}
                                    >
