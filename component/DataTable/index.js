...
import { Container, Text, Spacer, Divider } from "../index";
          ...
          return (
            <Container style={{}}>
              <Container row={!isMobile}>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <Container row={isMobile}>
                          {isMobile && (
                            <Container alignEnd justifyCenter style={styles.headerCellMobile}>
                              <Text.Small>{col.title}</Text.Small>
                            </Container>
                          )}
                          <Container
                            style={[
                              !isMobile ? styles.rowCell : styles.rowCellMobile,
                ...
                {isMobile && (
                  <Container fullWidth alignCenter>
                    <Spacer.Medium />
                    <Divider />
                    <Spacer.Medium />
                  </Container>
